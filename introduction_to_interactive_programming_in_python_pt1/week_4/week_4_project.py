...
def draw(canvas):
    ...
    if ball_pos[1] >= HEIGHT - BALL_RADIUS:
        ...
        ball_vel[1] = - ball_vel[1]
        ball_pos[1] += ball_vel[1]
    elif ball_pos[0] <= PAD_WIDTH + BALL_RADIUS and ball_pos[1] >= paddle1_top_pos[1] and ball_pos[1] <= paddle1_bottom_pos[1]:
        ball_vel[0] = - ball_vel[0] * ball_vel_incr
        ball_pos[0] += ball_vel[0] * ball_vel_incr
    elif ball_pos[0] <= PAD_WIDTH + BALL_RADIUS:
        score2 += 1
        spawn_ball(RIGHT)
    elif ball_pos[0] >= WIDTH - PAD_WIDTH - BALL_RADIUS and ball_pos[1] >= paddle2_top_pos[1] and ball_pos[1] <= paddle2_bottom_pos[1]:
        ball_vel[0] = - ball_vel[0] * ball_vel_incr
        ball_pos[0] += ball_vel[0] * ball_vel_incr
